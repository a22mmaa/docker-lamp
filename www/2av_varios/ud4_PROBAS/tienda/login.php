...
// Se xa está definido, que vaia para index
if (isset($_SESSION['nombre'])) {
    header('Location: index.php');
}

// Se non foi para index, que se poña todo a 0
$mensajes = array();
$nombre = "";
$password = "";


// Se está definido e hai erros, méteos no array de erros, se non, iguala nome e pass ás variabeis
...
// Se o array de erros está baleiro, segue adiante. Se ten algo, mostraos.
if (empty($mensajes)) {
